      ...
      <div className="content">
        ...
        <div className="stats-bar">
          ...
          <div className="stats-actions">
            <button className="btn-export" id="exportCsvBtn" type="button" disabled><i className="ti ti-download" /> Download CSV 5W+1H</button>
          </div>
        </div>
...
export default function CrawlingPage() {
  return (
    <LegacyPage
      ...
      extraStylesheets={["https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@latest/dist/tabler-icons.min.css","https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css"]}
